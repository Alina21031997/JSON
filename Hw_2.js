...
users.forEach(tempBlock => {console.log(tempBlock.registrationDate == '09.10.2021'||tempBlock.registrationDate == '10.10.2021'?
...
const enterprises = [
 ...
 const getEnterpriseName = function(searchld){
     let counter = 0 
     enterprises.forEach((iteam)=>{
         if(item.departaments){
             item.departaments.forEach((dep)=>{
                 if(dep.id == searchld || dep.name == searchld){
